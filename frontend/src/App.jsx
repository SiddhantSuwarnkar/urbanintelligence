...
import { 
  ...
  CheckCircle, RefreshCw, BarChart2, Map, Database,
  Activity, HelpCircle, Layers, List, Award, TrendingUp, Info,
...
export default function App() {
  ...
  const [swachhLeaderboard, setSwachhLeaderboard] = useState(null);
  ...
  }, [selectedCity, selectedCity2, compareMode, cities]);
  ...
  // Render air quality rating index text & color class
  const getAqiColor = (status) => {
    if (status === "Good") return "text-emerald-500 border-emerald-500/20 bg-emerald-500/5";
    if (status === "Moderate") return "text-amber-500 border-amber-500/20 bg-amber-500/5";
